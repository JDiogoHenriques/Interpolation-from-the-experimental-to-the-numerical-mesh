...
4. Move the example folder inside the folder "*/Experimental_Data/MatchID/0deg" (or "*/Experimental_Data/ARAMIS/Export_files_0d" depending if you download 2.1 or 2.2) and overwrite the contents of the preexisting folder.
